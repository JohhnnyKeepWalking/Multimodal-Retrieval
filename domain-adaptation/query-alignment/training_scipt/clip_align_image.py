...
class CLIPTwoTower(nn.Module):
    ...
    def load_from_checkpoint(self, checkpoint_path: str):
        if checkpoint_path is not None:
            ...
            # strip DDP "module." prefix AND "model." prefix if present
            new_state_dict = {}
            for k, v in state_dict.items():
                ...
                # Remove "model." prefix (from CLIPTwoTower wrapper)
    ...
    def forward(self, batch: dict) -> dict:
        ...
        image_emb = self.encode_image(batch["images"]) 
        q_i_align = self.in_batch_negative_sampling(query_emb, image_emb)
        return {
            "q_i_align": q_i_align
        }
...
class Trainer:
    def __init__(self, model, optimizer, loss_fn, scheduler):
        ...
        self.save_dir = "/home/jovyan/image_tt/checkpoints/clip_align_image/"
    ...
    def fit(self, train_loader, epochs: int, val_loader: Optional[DataLoader] = None):
        ...
        for epoch in range(epochs):
            ...
            for batch in train_loader:
                ...
                loss = self.loss_fn(results["q_i_align"], batch["desirability_label"], batch["relevance_label"])
            ...
            if self.accelerator.is_main_process:
                ...
                save_path = os.path.join(self.save_dir, f"clip_align_image_{epoch+1}.pt")
...
if __name__ == "__main__":
    ...
    model = CLIPTwoTower("ViT-B-32", pretrained="openai", checkpoint_path="/home/jovyan/image_tt/checkpoints/clip_align_text/clip_align_text_1.pt")
